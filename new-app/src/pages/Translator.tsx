            ...
            <div className="w-full">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Translate between English and Sinhala to help you communicate during your travels in Sri Lanka.
                    </p>
                </motion.div>
                ...
                <Card className="max-w-4xl mx-auto">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-6">
                            <span className="text-lg font-medium">{isEnglishToSinhala ? 'English' : 'Sinhala'}</span>
                            <Button variant="outline" size="icon" onClick={handleSwapLanguages} className="mx-4">
                                <ArrowRightLeft className="h-4 w-4" />
                            </Button>
                            <span className="text-lg font-medium">{isEnglishToSinhala ? 'Sinhala' : 'English'}</span>
                        </div>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {Object.entries(dummyTranslations)
                                    .slice(0, 6)
                                    .map(([english, sinhala]) => (
                                        <Button
                                            key={english}
