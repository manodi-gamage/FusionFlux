        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Discover the beauty of Sri Lanka - from pristine beaches to ancient temples,
              wildlife sanctuaries to tea plantations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/destinations" className="text-sm text-muted-foreground hover:text-primary">Destinations</Link></li>
              <li><Link to="/hotels" className="text-sm text-muted-foreground hover:text-primary">Hotels</Link></li>
              <li><Link to="/map" className="text-sm text-muted-foreground hover:text-primary">Map</Link></li>
              <li><Link to="/translator" className="text-sm text-muted-foreground hover:text-primary">Translator</Link></li>
            </ul>
          </div>
